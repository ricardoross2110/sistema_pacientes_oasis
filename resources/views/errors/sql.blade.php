      ...
      <section class="content">
        <div class="error-page">
            ...
            <div class="error-content">
                <h3><i class="fa fa-warning text-warning"></i> Lamentablemente tenemos un error de conexión a base de datos.</h3>

                <p>
                    Trabajaremos para poder solucionar el error, también puede ser por que no existe el dato que está buscando.
