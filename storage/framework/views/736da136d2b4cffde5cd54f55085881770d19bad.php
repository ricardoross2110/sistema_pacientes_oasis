    ...
    <section class="sidebar">
        <?php if(Auth::user()->perfil_id == 1 || Auth::user()->perfil_id == 2): ?>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="<?php echo Request::is('ReporteAtencionPeriodo') || Request::is('ReporteAtencionPeriodo/*') || Request::is('ReporteAtencionSucursal') || Request::is('ReporteAtencionSucursal/*') || Request::is('ReporteAtencionProfesional') || Request::is('ReporteAtencionProfesional/*') || Request::is('ReporteIngresoPeriodo') || Request::is('ReporteIngresoPeriodo/*') || Request::is('ReporteIngresoSucursal') || Request::is('ReporteIngresoSucursal/*') || Request::is('ReporteIngresoProfesional') || Request::is('ReporteIngresoProfesional/*') ? 'treeview active' : 'treeview'; ?>">
