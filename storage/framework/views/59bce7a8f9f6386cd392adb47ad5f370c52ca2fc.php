<?php $__env->startSection('htmlheader_title'); ?>
	Reporte ingresos por profesional
...
<?php $__env->startSection('breadcrumb_nivel'); ?>  
    ...
    <li class="active"> Reporte ingresos por profesional</li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="box box-info">
        ...
        <div class="box-body table-responsive">
          <?php echo Form::open(['route' => 'reportes.getIngresoProfesional', 'method' => 'POST']); ?>
          ...
          <br>
          <table class="table table-bordered table-striped" id="tablaIngresoProfesional">
            <thead>
              <tr>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var datosGrafico = [];
        ...
        $.ajax({
          url: "<?php echo e(url('reportes.getIngresoProfesional')); ?>",
          data    : { 
        ...
        .done(function(data) {
          $.each(JSON.parse(data.profesionales), function(index, val) {
             datosGrafico.push({'profesional' : index, 'ingresos' : val });
          });
          ...
          if (datosGrafico.length == 0) {
            var bar = new Morris.Bar({
              element: 'bar-chart1',
              resize: true,
              data: [{'profesional' : 'Sin datos', 'ingresos' : 0 }],
              barColors: ['#05B151'],
              xkey: 'profesional',
              ykeys: ['ingresos'],
              labels: ['Ingresos'],
      ...
      $('#tablaIngresoProfesional').DataTable({
        processing: true,
        pageLength: 10,
        searching   : false,
        language: {
        ...
        order: [[ 0, "asc" ]],
        ajax: {
            url: "reportes.getIngresoProfesional",
            type: "POST",
            data    : {
              fechadesde : fechadesde,
              fechahasta : fechahasta,
