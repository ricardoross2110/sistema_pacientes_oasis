        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6 col-sn-6 col-xs-6">
              <?php echo Form::label('fechahasta', 'Fecha desde:', ['for' => 'fechahasta'] ); ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="box box-info">
        ...
        <div class="box-body table-responsive">
          <?php echo Form::open(['route' => 'reportes.getAtencionPeriodo', 'method' => 'POST']); ?>
...
##parent-placeholder-16728d18790deb58b3b8c1df74f06e536b532695##
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $.ajax({
        url: "<?php echo e(url('reportes.getAtencionPeriodo')); ?>",
        data    : { 
